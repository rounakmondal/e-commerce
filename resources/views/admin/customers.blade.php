                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-borderless table-hover w-100 dt-responsive nowrap" id="products-datatable">
                                            ...
                                            <tbody>
                                                ...
                                                $data = DB::table('userinfodatas')->paginate(5);
                                             ...
                                             @foreach($data as $key)
                                                <tr>
                                                    ...
                                                    <td class="table-user">
                                                        ...
                                                        <a href="javascript:void(0);" class="text-body fw-semibold">{{$key->name}}</a>
                                                    </td>
                                                    <td>
                                                        {{$key->email}}
                                                    </td>
                                                    <td>
                                                        <span class="fw-semibold">   {{$key->phone_number}}</span>
                                                    </td>
                                              ...
                                              {{ $data->links() }}
                                           {{-- {{ $data->links('admin.sellers', ['foo' => 'bar']) }}  --}}
