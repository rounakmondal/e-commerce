...
<html lang="en">
      ...
      <div class="container">
        ...
        <div class="dropdown-menu dropdown-menu-right">
                  <div class="dropdown-item d-flex align-items-start" href="#">
                      <div class="img" style="background-image: url(user/images/prod-1.jpg);"></div>
                      <div class="text pl-3">
                          <h4>Bacardi 151</h4>
                  ...
                  <div class="dropdown-item d-flex align-items-start" href="#">
                      <div class="img" style="background-image: url(user/images/prod-2.jpg);"></div>
                      <div class="text pl-3">
                  ...
                  <div class="dropdown-item d-flex align-items-start" href="#">
                      <div class="img" style="background-image: url(user/images/prod-3.jpg);"></div>
                      <div class="text pl-3">
                          <h4>Citadelle</h4>
  ...
  <!-- END nav -->
  <div class="hero-wrap" style="background-image: url('user/images/bg_2.jpg');" data-stellar-background-ratio="0.5">
