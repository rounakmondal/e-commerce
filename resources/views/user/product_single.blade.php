...
{{-- disable rakhbte homet --}}
{{-- @php
$pdata=DB::table('productdatas')->();
...
<div class="container">
    <div class="row">
      ...
      <p><a class="btn btn-primary py-3 px-5 mr-2">Add to Cart</a><a href="#" class="btn btn-primary py-3 px-5">Buy now</a></p>
        </div>
    </div>
